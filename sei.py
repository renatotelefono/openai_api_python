...
if __name__ == "__main__":
    ...
    REPO_OWNER = "tuo-utente"   # <-- modifica qui
    REPO_NAME = "nome-repo"     # <-- modifica qui

    upload_to_github(
        repo_owner=REPO_OWNER,
        repo_name=REPO_NAME,
        path_in_repo=f"content/storie/{markdown_filename}",
    ...
    upload_to_github(
        repo_owner=REPO_OWNER,
        repo_name=REPO_NAME,
        path_in_repo=f"public/assets/{image_filename}",
